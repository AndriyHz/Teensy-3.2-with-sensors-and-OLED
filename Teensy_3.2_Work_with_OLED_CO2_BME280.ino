...
void loop()
{
 ...
 unsigned long valCO2 = getValue(response); 
  ...
  oled.setFontType(0);  // Set font to type 0
  oled.setCursor(85, 0); // move cursor
  ...
  oled.setFontType(0);  // Set font to type 0
  oled.setCursor(85, 9); // move cursor
  oled.print(capteur.readTempC(), 2);  // Write a byte out as a param
  ...
  oled.setFontType(0);  // Set font to type 0
  oled.setCursor(85, 17); // move cursor
  oled.print((capteur.readFloatPressure()*0.0075), 2);  // Write a byte out as a param
 ...
 // Humid
  ...
  oled.setFontType(0);  // Set font to type 0
  oled.setCursor(85, 25); // move cursor
  oled.print(capteur.readFloatHumidity(), 2);  // Write a byte out as a param
